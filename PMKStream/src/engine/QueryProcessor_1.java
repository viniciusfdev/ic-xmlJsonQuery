...
//     */
//    public QueryProcessor_1(String XMLFilePath, String queriesFileName, String absPath) {
...
//
//        if (numberOfThreads > 1) {
//            long[] times = {s2.getTempo(), p1.getTempo(), p3.getTempo(), p4.getTempo(), p5.getTempo(), p6.getTempo(), p7.getTempo(), p8.getTempo()};
//            for (long t : times) {
//                if (t > media) {
//                    media = t;
//                }
